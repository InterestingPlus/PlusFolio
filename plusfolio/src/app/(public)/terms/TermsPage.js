        ...
        <div className="mx-auto mt-10 max-w-4xl lg:max-w-none lg:grid lg:grid-cols-12 lg:gap-12">
          ...
          <div className="lg:col-span-8 xl:col-span-9 max-w-3xl space-y-12">
            ...
            <TermsSection id="user-accounts" title="4. User Accounts">
              <p>
                You can register for a PlusFolio account using an Email/Password
                combination or through trusted third-party OAuth providers (such
                as Google and LinkedIn).
              </p>
              <ul className="list-disc pl-6 space-y-1.5 text-slate-600">
                <li>
                  <strong>Cloud Storage:</strong> Registered users can securely
                  save, manage, update, and download their documents across
                  multiple devices.
                </li>
                <li>
                ...
                <li>
                  <strong>Accurate Info:</strong> You agree to provide accurate
                  email details so we can assist you with password resets or
            ...
            <TermsSection id="guest-mode" title="5. Guest Mode (No Login)">
              ...
              <ul className="list-disc pl-6 space-y-1.5 text-slate-600">
                <li>
                  <strong>Local Browser Storage:</strong> When using Guest Mode,
                  your resume and biodata data is saved directly in your
                  device's browser memory (Local Storage / IndexedDB).
                </li>
                <li>
                  <strong>User Responsibility:</strong> Because Guest Mode data
                  is not synced to our cloud servers, clearing your browser
                  cache or switching devices will erase your work. We recommend
                  downloading your completed PDFs or creating an account to save
                  important drafts.
                </li>
              </ul>
            </TermsSection>
            ...
            <TermsSection id="acceptable-use" title="6. Acceptable Use">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 list-disc pl-6 text-slate-600">
                ...
                <li>Use automated bots to generate excessive server loads.</li>
                <li>
            ...
            >
              <p>
                ...
                structure bullet points, suggest professional wording, and parse
                rough text into organized career profiles.
              </p>
              <p>
            ...
            >
              <p>
                ...
                ownership over all text, work history, biodata details, images,
                and portfolios that you enter into PlusFolio.
              </p>
              <p>
            ...
            >
              <p>
                ...
                <strong>PlusFolio and INTERESTING Plus</strong> retain complete
                intellectual property ownership over the platform itself. This
              ...
              <p className="mt-2">
                You may not redistribute, resell, or package PlusFolio templates
                as your own competing commercial product.
              </p>
            </TermsSection>
            ...
            <TermsSection id="advertisements" title="10. Advertisements">
              <p>
                ...
                through trusted partners such as <strong>Google AdSense</strong>
                .
              </p>
              <p>
            ...
            >
              ...
              <p className="mt-2">
                ...
                Existing free core functionalities will always be transparently
            ...
            >
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 list-disc pl-6 text-slate-600">
                ...
                <li>
                  <strong>Google Analytics &amp; Clarity:</strong> For anonymous
                  product analytics.
                </li>
              </ul>
              <p className="mt-2">
                Your interaction with third-party providers is subject to their
            ...
            >
              <p>
                ...
                explicit or implied warranties of any kind. We provide software
                tools to assist your document design, but we make no guarantees
                regarding real-world career outcomes.
              </p>
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-5 text-sm">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 list-disc pl-6 text-slate-600">
                  ...
                  <li>Marriage proposals or matrimonial matchmaking success</li>
            ...
            >
              <p>
                ...
                consequential, special, or punitive damages arising out of your
                use of the Platform.
              </p>
              <p>
                This includes, without limitation, losses related to employment
                opportunities, rejected applications, data loss, or system
                interruptions.
              </p>
            </TermsSection>
            ...
            >
              <p>
                ...
                your account from your user dashboard and clearing your local
                browser data.
              </p>
              <p>
                We reserve the right to suspend or permanently terminate
                accounts that violate these Terms, engage in server abuse,
                attempt unauthorized access, or use our tools for fraudulent or
                malicious purposes.
              </p>
            </TermsSection>
            ...
            <TermsSection id="fair-usage-policy" title="17. Fair Usage Policy">
              <p>
                To ensure fast server response times and reliable AI generation
                for all users, PlusFolio operates under a community Fair Usage
                Policy.
              </p>
              ...
              <p>
                Automated scraping of AI endpoints, scripts designed to overload
                document rendering, or sharing single accounts among massive
            ...
            <TermsSection id="privacy" title="18. Privacy">
              <p>
                Your privacy is a core principle of PlusFolio. Our data handling
                practices—including how we manage local browser storage,
                authentication cookies, and optional cloud backups—are
                comprehensively detailed in our{" "}
                <a
                  href="/privacy"
            ...
            <TermsSection id="governing-law" title="20. Governing Law (India)">
              <p>
              ...
              <p>
                Any legal actions or proceedings relating to PlusFolio shall be
