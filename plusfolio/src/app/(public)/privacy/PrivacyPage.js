          ...
          <div className="lg:col-span-8 xl:col-span-9 max-w-3xl space-y-12">
            ...
            <section id="who-we-are" className="scroll-mt-28 space-y-4">
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-xs">
                <dl className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2 text-sm">
                  ...
                  <div>
                    <dt className="font-semibold text-slate-500">Portfolio</dt>
                    <dd className="mt-1">
                      <a
                        href="https://jatinporiya.netlify.app"
                        target="_blank"
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-slate-600">
                  If you choose to create resumes or other career documents, you
                  may provide:
                </p>
            ...
            <section id="analytics" className="scroll-mt-28 space-y-4">
              ...
              <p className="mt-3 text-slate-600 leading-relaxed">
                These services may collect anonymous usage information such as:
              </p>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 list-disc pl-6 text-slate-600">
                <li>Browser type</li>
            ...
            <section id="data-security" className="scroll-mt-28 space-y-4">
              ...
              <div className="space-y-3 text-slate-600 leading-relaxed">
                ...
                <p>
                  Guest Mode users benefit from local-only storage for supported
                  features, while registered users' data is protected through
                  secure authentication and encrypted communication wherever
                  applicable.
                </p>
                <p>
                  Although no online service can guarantee absolute security, we
            ...
            <section id="childrens-privacy" className="scroll-mt-28 space-y-4">
              ...
              <div className="space-y-3 text-slate-600 leading-relaxed">
                ...
                <p>
                  If you are under 13 years of age, please use the platform with
            ...
            <section id="changes-to-policy" className="scroll-mt-28 space-y-4">
              ...
              <div className="space-y-3 text-slate-600 leading-relaxed">
                ...
                <p>
                  Continued use of PlusFolio after updates indicates acceptance
