            ...
            <div className="lg:col-span-8 xl:col-span-9 max-w-3xl space-y-16">
              ...
              <section id="who-we-are" className="scroll-mt-28 space-y-4">
                ...
                <div className="space-y-4 text-base sm:text-lg leading-relaxed text-slate-600">
                  <p>
                    ...
                    is an independent, technology-driven career platform built
                    by{" "}
                    <a
                      href="https://www.interestingplus.qzz.io"
                      target="_blank"
                    ...
                    presentation should never be locked behind expensive
                    paywalls or frustrating software.
                  </p>
                  <p>
                    Whether you are a college student writing your first resume,
                    an experienced professional optimizing for applicant
                    tracking systems, or a freelancer setting up a personal
                    portfolio, our tools give you the clarity and structure you
                    need to succeed.
                  </p>
                </div>
              </section>
              ...
              <section id="our-story" className="scroll-mt-28 space-y-4">
                ...
                <div className="space-y-4 text-base sm:text-lg leading-relaxed text-slate-600">
                  ...
                  <p>
                    ...
                    combined clean design engineering, optional AI assistance,
                    and privacy-first local storage so that anyone anywhere can
                    build industry-ready career documents in minutes.
                  </p>
                </div>
              </section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Essential job-hunting utilities should be free. We keep
                      core builders accessible without hidden download fees.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      We treat your personal data with absolute respect. Use
                      tools without logging in via local browser storage.
                    </p>
                  </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-slate-600 leading-relaxed">
                          Whether you are in Mumbai, New York, London, or
                          Nairobi, our platform is optimized for fast
                          performance and cross-device compatibility globally.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs hover:border-blue-300 transition-all flex flex-col justify-between">
                    <div>
                      ...
                      <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                        Analyze your resume against automated screening
                        algorithms to identify keyword gaps and improve
                        interview callbacks.
                      </p>
                    </div>
                    <div className="mt-6 pt-4 border-t border-slate-100">
              ...
              <section id="why-choose" className="scroll-mt-28 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xs">
                    ...
                    <p className="mt-1 text-xs text-slate-600 leading-relaxed">
                      Zero bloat or clutter—focus entirely on telling your
                      story.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-cols-3 gap-5">
                  <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
                    ...
                    <p className="mt-1.5 text-xs sm:text-sm text-slate-600 leading-relaxed">
                      Clear pricing, open documentation, and no dark UI
                      patterns. What you see is always what you get.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
                    ...
                    <p className="mt-1.5 text-xs sm:text-sm text-slate-600 leading-relaxed">
                      We listen closely to community feedback and ship
                      meaningful platform improvements every single week.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-4 text-sm sm:text-base text-slate-600 leading-relaxed">
                        ...
                        to put professional document design back into the hands
                        of the user.
                      </p>
                    </div>
                  </div>
                ...
                <div className="rounded-2xl bg-gradient-to-br from-slate-900 via-slate-800 to-blue-950 p-8 sm:p-10 text-white shadow-xl shadow-slate-900/5">
                  <div className="max-w-xl">
                    ...
                    <p className="mt-3 text-sm sm:text-base text-slate-300 leading-relaxed">
                      PlusFolio grows through community conversations. Whether
                      you want to report a bug, suggest a new template layout,
              ...
              <div className="pt-4 text-center">
                <p className="text-sm sm:text-base font-medium text-slate-500 italic">
                  "Thank you for being a part of the PlusFolio journey. We're
