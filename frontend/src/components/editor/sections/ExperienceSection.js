...
export function ExperienceSection({ data, onChange }) {
  ...
  const updateDesc = (id, index, value) => {
  ...
  const removeDesc = (id, index) => {
    const exp = data.find((e) => e.id === id);
    update(
      id,
      "description",
      exp.description.filter((_, i) => i !== index),
    );
  };
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">
          Highlight your professional background to show your impact.
        </p>
      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  <div>
                    ...
                    <input
                      ...
                      value={exp.job_title}
                      onChange={(e) =>
                        update(exp.id, "job_title", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        update(exp.id, "start_date", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={(e) =>
                          update(exp.id, "end_date", e.target.value)
                        }
                        placeholder="Present"
                      ...
                      <label className="flex items-center gap-1.5 cursor-pointer whitespace-nowrap">
                        <input
                          ...
                          onChange={(e) =>
                            update(exp.id, "is_current", e.target.checked)
                          }
                  ...
                  <div className="sm:col-span-2">
                      ...
                      {exp.description.map((desc, di) => (
                        <div key={di} className="flex items-start gap-2">
                          ...
                          <input
                            ...
                            value={desc}
                            onChange={(e) =>
                              updateDesc(exp.id, di, e.target.value)
                            }
                    ...
                    <p className="text-xs text-gray-400 mt-2">
                      Tip: Use action verbs and quantify your achievements.
                    </p>
                  </div>
                </div>
              </div>
