export function ResumePreviewPanel({ resume }) {
  const {
    personal_info,
    summary,
    experience,
  ...
  return (
    <div className="bg-white shadow-sm text-gray-900 text-[10px] leading-[1.4] font-sans p-6 min-h-full">
      ...
      {summary && (
        <div className="mb-4">
          <h2 className="text-[10px] font-bold uppercase tracking-widest text-gray-500 border-b border-gray-200 pb-1 mb-2">
            Summary
          </h2>
                ...
                {exp.description.length > 0 && (
                  <ul className="mt-1 space-y-0.5 pl-3">
                    {exp.description.map((d, i) => (
                      <li
                        key={i}
                        className="text-gray-600 relative before:content-['•'] before:absolute before:-left-2.5 before:text-gray-400"
                      >
                        {d}
                      </li>
                    ))}
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-1">
                {skills.map((skill, i) => (
                  <span
                    key={i}
                    className="bg-gray-100 text-gray-700 px-1.5 py-0.5 rounded text-[9px]"
                  >
                    {skill}
                  </span>
                ))}
  ...
  return (
    <div className="bg-white text-gray-900 text-[10px] leading-[1.4] font-sans">
      ...
      <div className="p-6">
        {summary && (
          <div className="mb-4">
            <h2 className="text-[10px] font-bold uppercase tracking-widest text-gray-800 border-b-2 border-gray-800 pb-1 mb-2">
              Profile
            </h2>
